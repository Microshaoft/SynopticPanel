        ...
        if (itemsWithCustomIcons.length > 0) {
            ...
            group.selectAll('.legendItem').each(function (d, i) {
                ...
                for (let i = 0; i < itemsWithCustomIcons.length; i++) {
                    ...
                    let found = false;
                    if (item.identityToFind && item.identityToFind.equals(el.datum().identity))
                        found = true;
                    else if (item.labelToFind && el.datum().tooltip == item.labelToFind)
                        found = true;
                    ...
                    if (found) {
                        ...
                        } else if (item.icon == 'line' || item.icon == 'vline') {
